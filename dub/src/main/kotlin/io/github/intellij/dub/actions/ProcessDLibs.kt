    ...
    */
    ...
    companion object {
        ...
        private fun processDLibsImpl(project: Project, module: Module,
            ...
            val dubParser = DubConfigurationParser(
                project, dubPath,
                mostlySilentMode
            )
        ...
        */
        ...
        private fun showModuleChoicePopup(e: AnActionEvent, project: Project, modules: Collection<Module>) {
            val popup = JBPopupFactory.getInstance()
                ...
                .setItemChosenCallback { module -> processDLibs(getEventProject(e), module) }
                .setCancelCallback {
        ...
        private fun getSourcesVirtualFile(dubPackage: DubPackage): VirtualFile? {
            ...
            return VirtualFileManager.getInstance()
                .refreshAndFindFileByUrl(sourcesPathUrl) ?: return dubFetch(dubPackage, sourcesPathUrl)
        }
