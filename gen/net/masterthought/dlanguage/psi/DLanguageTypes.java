...
public interface DLanguageTypes {
  ...
  IElementType ADD_EXPRESSION_ = new DLanguageElementType("ADD_EXPRESSION_");
  ...
  IElementType ALIAS_DECLARATION_SINGLE = DElementTypeFactory.factory("ALIAS_DECLARATION_SINGLE");
  ...
  IElementType CONDITIONAL_EXPRESSION_ = new DLanguageElementType("CONDITIONAL_EXPRESSION_");
  ...
  IElementType MUL_EXPRESSION_ = new DLanguageElementType("MUL_EXPRESSION_");
  ...
  IElementType POW_EXPRESSION_ = new DLanguageElementType("POW_EXPRESSION_");
  ...
  IElementType SHIFT_EXPRESSION_ = new DLanguageElementType("SHIFT_EXPRESSION_");
  ...
  IElementType VAR_FUNC_DECLARATION = DElementTypeFactory.factory("VAR_FUNC_DECLARATION");
  ...
  IElementType XOR_EXPRESSION_ = new DLanguageElementType("XOR_EXPRESSION_");
  ...
  IElementType KW_ABSTRACT = new DLanguageTokenType("abstract");
  IElementType KW_ALIAS = new DLanguageTokenType("alias");
  IElementType KW_ALIGN = new DLanguageTokenType("align");
  IElementType KW_ASM = new DLanguageTokenType("asm");
  IElementType KW_ASSERT = new DLanguageTokenType("assert");
  IElementType KW_AUTO = new DLanguageTokenType("auto");
  IElementType KW_BODY = new DLanguageTokenType("body");
  IElementType KW_BOOL = new DLanguageTokenType("bool");
  IElementType KW_BREAK = new DLanguageTokenType("break");
  IElementType KW_BYTE = new DLanguageTokenType("byte");
  ...
  IElementType KW_CLASS = new DLanguageTokenType("class");
  IElementType KW_CONST = new DLanguageTokenType("const");
  IElementType KW_CONTINUE = new DLanguageTokenType("continue");
  IElementType KW_CREAL = new DLanguageTokenType("creal");
  IElementType KW_DCHAR = new DLanguageTokenType("dchar");
  IElementType KW_DEBUG = new DLanguageTokenType("debug");
  IElementType KW_DEFAULT = new DLanguageTokenType("default");
  ...
  IElementType KW_ENUM = new DLanguageTokenType("enum");
  IElementType KW_EXPORT = new DLanguageTokenType("export");
  IElementType KW_EXTERN = new DLanguageTokenType("extern");
  IElementType KW_FALSE = new DLanguageTokenType("false");
  IElementType KW_FINAL = new DLanguageTokenType("final");
  IElementType KW_FINALLY = new DLanguageTokenType("finally");
  IElementType KW_FLOAT = new DLanguageTokenType("float");
  IElementType KW_FOR = new DLanguageTokenType("for");
  IElementType KW_FOREACH = new DLanguageTokenType("foreach");
  IElementType KW_FOREACH_REVERSE = new DLanguageTokenType("foreach_reverse");
  IElementType KW_FUNCTION = new DLanguageTokenType("function");
  IElementType KW_GOTO = new DLanguageTokenType("goto");
  IElementType KW_IDOUBLE = new DLanguageTokenType("idouble");
  IElementType KW_IF = new DLanguageTokenType("if");
  IElementType KW_IFLOAT = new DLanguageTokenType("ifloat");
  IElementType KW_IMMUTABLE = new DLanguageTokenType("immutable");
  IElementType KW_IMPORT = new DLanguageTokenType("import");
  IElementType KW_IN = new DLanguageTokenType("in");
  IElementType KW_INOUT = new DLanguageTokenType("inout");
  IElementType KW_INT = new DLanguageTokenType("int");
  IElementType KW_INTERFACE = new DLanguageTokenType("interface");
  IElementType KW_INVARIANT = new DLanguageTokenType("invariant");
  IElementType KW_IREAL = new DLanguageTokenType("ireal");
  IElementType KW_IS = new DLanguageTokenType("is");
  IElementType KW_LAZY = new DLanguageTokenType("lazy");
  IElementType KW_LONG = new DLanguageTokenType("long");
  ...
  IElementType KW_STATIC = new DLanguageTokenType("static");
  IElementType KW_STRUCT = new DLanguageTokenType("struct");
  ...
  IElementType KW_UBYTE = new DLanguageTokenType("ubyte");
  IElementType KW_UINT = new DLanguageTokenType("uint");
  IElementType KW_ULONG = new DLanguageTokenType("ulong");
  IElementType KW_UNION = new DLanguageTokenType("union");
  IElementType KW_UNITTEST = new DLanguageTokenType("unittest");
  IElementType KW_USHORT = new DLanguageTokenType("ushort");
  IElementType KW_VERSION = new DLanguageTokenType("version");
  IElementType KW_VOID = new DLanguageTokenType("void");
  ...
  IElementType OP_AT = new DLanguageTokenType("@");
  IElementType OP_BOOL_AND = new DLanguageTokenType("&&");
  IElementType OP_BOOL_OR = new DLanguageTokenType("||");
  IElementType OP_BRACES_LEFT = new DLanguageTokenType("{");
  IElementType OP_BRACES_RIGHT = new DLanguageTokenType("}");
  IElementType OP_BRACKET_LEFT = new DLanguageTokenType("[");
  IElementType OP_BRACKET_RIGHT = new DLanguageTokenType("]");
  IElementType OP_COLON = new DLanguageTokenType(":");
  IElementType OP_COMMA = new DLanguageTokenType(",");
  IElementType OP_DDOT = new DLanguageTokenType("..");
  IElementType OP_DIV = new DLanguageTokenType("/");
  IElementType OP_DIV_EQ = new DLanguageTokenType("/=");
  IElementType OP_DOLLAR = new DLanguageTokenType("$");
  IElementType OP_DOT = new DLanguageTokenType(".");
  IElementType OP_EQ = new DLanguageTokenType("=");
  IElementType OP_EQ_EQ = new DLanguageTokenType("==");
  IElementType OP_GT = new DLanguageTokenType(">");
  IElementType OP_GT_EQ = new DLanguageTokenType(">=");
  IElementType OP_LAMBDA_ARROW = new DLanguageTokenType("=>");
  IElementType OP_LESS = new DLanguageTokenType("<");
  IElementType OP_LESS_EQ = new DLanguageTokenType("<=");
  IElementType OP_LESS_GR = new DLanguageTokenType("<>");
  IElementType OP_LESS_GR_EQ = new DLanguageTokenType("<>=");
  IElementType OP_MINUS = new DLanguageTokenType("-");
  IElementType OP_MINUS_EQ = new DLanguageTokenType("-=");
  IElementType OP_MINUS_MINUS = new DLanguageTokenType("--");
  IElementType OP_MOD = new DLanguageTokenType("%");
  IElementType OP_MOD_EQ = new DLanguageTokenType("%=");
  IElementType OP_MUL_EQ = new DLanguageTokenType("*=");
  IElementType OP_NOT = new DLanguageTokenType("!");
  IElementType OP_NOT_EQ = new DLanguageTokenType("!=");
  IElementType OP_NOT_GR = new DLanguageTokenType("!>");
  IElementType OP_NOT_GR_EQ = new DLanguageTokenType("!>=");
  IElementType OP_NOT_LESS = new DLanguageTokenType("!<");
  IElementType OP_NOT_LESS_EQ = new DLanguageTokenType("!<=");
  IElementType OP_OR = new DLanguageTokenType("|");
  IElementType OP_OR_EQ = new DLanguageTokenType("|=");
  IElementType OP_PAR_LEFT = new DLanguageTokenType("(");
  IElementType OP_PAR_RIGHT = new DLanguageTokenType(")");
  IElementType OP_PLUS = new DLanguageTokenType("+");
  IElementType OP_PLUS_EQ = new DLanguageTokenType("+=");
  IElementType OP_PLUS_PLUS = new DLanguageTokenType("++");
  IElementType OP_POW = new DLanguageTokenType("^^");
  IElementType OP_POW_EQ = new DLanguageTokenType("^^=");
  IElementType OP_QUEST = new DLanguageTokenType("?");
  IElementType OP_SCOLON = new DLanguageTokenType(";");
  IElementType OP_SH_LEFT = new DLanguageTokenType("<<");
  IElementType OP_SH_LEFT_EQ = new DLanguageTokenType("<<=");
  IElementType OP_SH_RIGHT = new DLanguageTokenType(">>");
  IElementType OP_SH_RIGHT_EQ = new DLanguageTokenType(">>=");
  IElementType OP_TILDA = new DLanguageTokenType("~");
  IElementType OP_TILDA_EQ = new DLanguageTokenType("~=");
  IElementType OP_TRIPLEDOT = new DLanguageTokenType("...");
  IElementType OP_UNORD = new DLanguageTokenType("!<>=");
  IElementType OP_UNORD_EQ = new DLanguageTokenType("!<>");
  IElementType OP_USH_RIGHT = new DLanguageTokenType(">>>");
    ...
    public static PsiElement createElement(ASTNode node) {
      IElementType type = node.getElementType();
       if (type == ADD_EXPRESSION_) {
        return new DLanguageAddExpression_Impl(node);
      }
      ...
      else if (type == ALIAS_DECLARATION_SINGLE) {
        return new DLanguageAliasDeclarationSingleImpl(node);
      }
      ...
      else if (type == CONDITIONAL_EXPRESSION_) {
        return new DLanguageConditionalExpression_Impl(node);
      }
      else if (type == CONDITIONAL_STATEMENT) {
        return new DLanguageConditionalStatementImpl(node);
      }
      else if (type == CONDITION_VARIABLE_DECLARATION) {
        return new DLanguageConditionVariableDeclarationImpl(node);
      }
      ...
      else if (type == MUL_EXPRESSION_) {
        return new DLanguageMulExpression_Impl(node);
      }
      ...
      else if (type == POW_EXPRESSION_) {
        return new DLanguagePowExpression_Impl(node);
      }
      else if (type == PRAGMA) {
      ...
      else if (type == SHIFT_EXPRESSION_) {
        return new DLanguageShiftExpression_Impl(node);
      }
      ...
      else if (type == VAR_FUNC_DECLARATION) {
        return new DLanguageVarFuncDeclarationImpl(node);
      }
      ...
      else if (type == XOR_EXPRESSION_) {
        return new DLanguageXorExpression_Impl(node);
      }
