...
public class DLanguageImportStatementImpl extends ASTWrapperPsiElement implements DLanguageImportStatement {

  public DLanguageImportStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DLanguageVisitor) ((DLanguageVisitor)visitor).visitImportStatement(this);
