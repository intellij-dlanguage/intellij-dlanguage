...
public class DLanguageTemplateTupleParameterImpl extends ASTWrapperPsiElement implements DLanguageTemplateTupleParameter {
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DLanguageVisitor) ((DLanguageVisitor)visitor).visitTemplateTupleParameter(this);
    else super.accept(visitor);
  }

  @Override
  @NotNull
  public PsiElement getVararg() {
    return findNotNullChildByType(VARARG);
  }
