...
public class DLanguageStructTemplateDeclarationImpl extends ASTWrapperPsiElement implements DLanguageStructTemplateDeclaration {

  public DLanguageStructTemplateDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DLanguageVisitor) ((DLanguageVisitor)visitor).visitStructTemplateDeclaration(this);
