...
static this() {
    ...
    types_mixins["AddExpression"] = "DLanguageAddExpressionImplMixin";
    ...
    types_mixins["AndAndExpression"] = "DLanguageAndAndExpressionImplMixin";
    ...
    types_children["ArrayInitializer"] = ["OP_BRACKET_LEFT", "OP_COMMA*", "ArrayMemberInitializer*", "OP_BRACKET_RIGHT"];
    types_children["ArrayLiteral"] = ["OP_BRACKET_LEFT", "OP_COMMA*", "Expression*", "OP_BRACKET_RIGHT"];
    ...
    types_children["ArrayMemberInitializer"] = ["Expression", "OP_COLON", "ArrayLiteral", "StructInitializer", "OP_BRACES_LEFT"];
    ...
    types_mixins["AssertExpression"] = "DLanguageAssertExpressionImplMixin";
    ...
    types_mixins["AssignExpression"] = "DLanguageAssignExpressionImplMixin";
    ...
    types_mixins["DeleteExpression"] = "DLanguageDeleteExpressionImplMixin";
    ...
    types_mixins["EqualExpression"] = "DLanguageEqualExpressionImplMixin";
    ...
    types_mixins["FundamentalTypePropertyExpression"] = "DLanguageFundamentalTypePropertyExpressionImplMixin";
    ...
    types_mixins["FunctionLiteralExpression"] = "DLanguageFunctionLiteralExpressionImplMixin";
    ...
    types_children["IndexExpression"] = ["OP_BRACKET_LEFT","OP_BRACKET_RIGHT","Expression*", "OP_COMMA*", "OP_COLON*", "OP_DDOT*"]; // contrary to what his name suggest, it is not an expression
    types_children["InExpression"] = ["ShiftExpression*","KW_IN","OP_NOT"];
    types_children["Initializer"] = ["KW_VOID","Expression", "ArrayInitializer", "StructInitializer"];
    ...
    types_mixins["IsExpression"] = "DLanguageIsExpressionImplMixin";
    types_extra_interfaces["IsExpression"] = ["Expression"];
    types_children["KeyValuePair"] = ["Expression*","OP_COLON"];
    ...
    types_mixins["MagicLiteralExpression"] = "DLanguageMagicLiteralExpressionImplMixin";
    ...
    types_extra_interfaces["OrExpression"] = ["BitwiseExpression"];
    ...
    types_mixins["RelExpression"] = "DLanguageRelExpressionImplMixin";
    ...
    types_mixins["ShiftExpression"] = "DLanguageShiftExpressionImplMixin";
    ...
    types_children["StructInitializer"] = ["OP_BRACES_LEFT", "StructMemberInitializer*", "OP_COMMA*", "OP_BRACES_RIGHT",];
    ...
    types_mixins["TemplateThisParameter"] = "DLanguageTemplateThisParameterImplMixin";
    ...
    types_mixins["TernaryExpression"] = "DLanguageTernaryExpressionImplMixin";
    types_extra_interfaces["TernaryExpression"] = ["Expression"];
    types_children["ThrowExpression"] = ["KW_THROW","Expression","OP_SCOLON"];
    types_mixins["ThrowExpression"] = "DLanguageThrowExpressionImplMixin";
    ...
    types_mixins["TraitsExpression"] = "DLanguageTraitsExpressionImplMixin";
    ...
    types_mixins["TypeConstructExpression"] = "DLanguageTypeConstructExpressionImplMixin";
    ...
    types_mixins["TypeidExpression"] = "DLanguageTypeidExpressionImplMixin";
    ...
    types_mixins["TypeofExpression"] = "DLanguageTypeofExpressionImplMixin";
    ...
    types_children["TypeSuffix"] = ["Expression*","OP_TRIPLEDOT","KW_FUNCTION","KW_DELEGATE","OP_ASTERISK","MemberFunctionAttribute*","Parameters","Type","OP_BRACKET_LEFT","OP_BRACKET_RIGHT"];
    ...
    has_processDeclaration["ArrayMemberInitializer"] = false;
...
int main(string[] args) {
    ...
    if (args.length != 2 || (args[1] != "Interface" && args[1] != "Implementation")) {
        writeln("Error: need to provide the target (Interface or Implementation)");
        return 1;
    }
