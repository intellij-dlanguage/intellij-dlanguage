...
public interface DlangTypes {
    ...
    IElementType CLASS_DECLARATION = DStubElementTypes.CLASS_DECLARATION;
    IElementType INTERFACE_DECLARATION = DStubElementTypes.INTERFACE_DECLARATION;
    IElementType TEMPLATE_DECLARATION = DStubElementTypes.TEMPLATE_DECLARATION;
    IElementType CONSTRUCTOR = DStubElementTypes.CONSTRUCTOR;
    IElementType DESTRUCTOR = DStubElementTypes.DESTRUCTOR;
    IElementType STRUCT_DECLARATION = DStubElementTypes.STRUCT_DECLARATION;
    IElementType ALIAS_INITIALIZER = DStubElementTypes.ALIAS_INITIALIZER;
    IElementType MODULE_DECLARATION = DStubElementTypes.MODULE_DECLARATION;
    IElementType IDENTIFIER_INITIALIZER = DStubElementTypes.IDENTIFIER_INITIALIZER;
    IElementType LABELED_STATEMENT = DStubElementTypes.LABELED_STATEMENT;
    IElementType SHARED_STATIC_CONSTRUCTOR = DStubElementTypes.SHARED_STATIC_CONSTRUCTOR;
    IElementType SHARED_STATIC_DESTRUCTOR = DStubElementTypes.SHARED_STATIC_DESTRUCTOR;
    IElementType STATIC_CONSTRUCTOR = DStubElementTypes.STATIC_CONSTRUCTOR;
    IElementType STATIC_DESTRUCTOR = DStubElementTypes.STATIC_DESTRUCTOR;
    IElementType AUTO_ASSIGNMENT = DStubElementTypes.AUTO_ASSIGNMENT;
    IElementType ENUM_DECLARATION = DStubElementTypes.ENUM_DECLARATION;
    IElementType UNION_DECLARATION = DStubElementTypes.UNION_DECLARATION;
    IElementType SINGLE_IMPORT = DStubElementTypes.SINGLE_IMPORT;
    IElementType UNITTEST = DStubElementTypes.UNITTEST;
    IElementType CATCH = DStubElementTypes.CATCH;
    IElementType IF_CONDITION = DStubElementTypes.IF_CONDITION;
    IElementType FOREACH_TYPE = DStubElementTypes.FOREACH_TYPE;
    IElementType PARAMETER = DStubElementTypes.PARAMETER;
    IElementType TEMPLATE_ALIAS_PARAMETER = DStubElementTypes.TEMPLATE_ALIAS_PARAMETER;
    IElementType TEMPLATE_TUPLE_PARAMETER = DStubElementTypes.TEMPLATE_TUPLE_PARAMETER;
    IElementType TEMPLATE_TYPE_PARAMETER = DStubElementTypes.TEMPLATE_TYPE_PARAMETER;
    IElementType TEMPLATE_VALUE_PARAMETER = DStubElementTypes.TEMPLATE_VALUE_PARAMETER;
    IElementType ENUM_MEMBER = DStubElementTypes.ENUM_MEMBER;
    IElementType NAMED_IMPORT_BIND = DStubElementTypes.NAMED_IMPORT_BIND;
    IElementType VERSION_SPECIFICATION = DStubElementTypes.VERSION_SPECIFICATION;
    IElementType DECLARATOR_IDENTIFIER = DStubElementTypes.DECLARATOR_IDENTIFIER;
    IElementType IMPORT_DECLARATION = DStubElementTypes.IMPORT_DECLARATION;
