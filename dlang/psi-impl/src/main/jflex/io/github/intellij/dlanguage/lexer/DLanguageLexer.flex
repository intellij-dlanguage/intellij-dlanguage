...
BINARY_INTEGER = (0[bB]) {BINARY_DIGITS_NO_SINGLE_US}? // Note: understand incomplete binary integer (no digit) to allow better error message
HEXADECIMAL_INTEGER = {HEX_PREFIX} {HEX_DIGITS_NO_SINGLE_US}? // Note: understand incomplete hex integer (no digit) to allow better error message
NON_ZERO_DIGIT = [1-9]
