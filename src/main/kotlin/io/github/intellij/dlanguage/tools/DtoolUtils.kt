...
class DtoolUtils {
    ...
    companion object {
        ...
        const val DMD_LATEST: String = "2.085.1"
        const val LDC_LATEST: String = "1.15.0"

        const val SERVE_D_LATEST: String = "0.4.1"

        const val DUB_LATEST: String = "1.14.0"
        const val DSCANNER_LATEST: String = "v0.7.1" // v0.5.0-rc1
        const val DCD_LATEST: String = "v0.11.1" // v0.9.10, OR v0.9.10-alpha.0
        const val DFORMAT_LATEST: String = "v0.10.0"
