...
class DtoolUtils {
    ...
    companion object {
        ...
        const val DMD_LATEST: String = "2.105.0"
        const val LDC_LATEST: String = "1.33.0"

        const val SERVE_D_LATEST: String = "0.7.4"

        const val DUB_LATEST: String = "1.34.0"
        const val DSCANNER_LATEST: String = "v0.15.2" // v0.5.0-rc1
