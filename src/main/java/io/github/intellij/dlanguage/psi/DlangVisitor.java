...
public class DlangVisitor extends PsiElementVisitor {
    ...
    public void visitAssertArguments(@NotNull final DLanguageAssertArgumentsImpl o) {
        visitPsiElement(o);
    }
    ...
    public void visitAttributeSpecifier(@NotNull final DLanguageAttributeSpecifierImpl o) {
        visitPsiElement(o);
    }
    ...
    public void visitDeclarationBlock(@NotNull final DLanguageDeclarationBlockImpl o) {
        visitPsiElement(o);
    }

    public void visitDeclarationStatement(@NotNull final DLanguageDeclarationStatementImpl o) {
        visitPsiElement(o);
    }
     ...
     */
    public void visitDeclarator(@NotNull final DLanguageIdentifierInitializerImpl declarator) {
    ...
    public void visitEmptyDeclaration(@NotNull final DLanguageEmptyDeclarationImpl o) {
        visitPsiElement(o);
    }
    ...
    public void visitFunctionContract(@NotNull final DLanguageFunctionContractImpl o) {
        visitPsiElement(o);
    }
    ...
    public void visitInContractExpression(@NotNull final DLanguageInContractExpressionImpl o) {
        visitPsiElement(o);
    }

    public void visitInOutContractExpression(@NotNull final DLanguageInOutContractExpressionImpl o) {
        visitPsiElement(o);
    }
    ...
    public void visitInOutStatement(@NotNull final DLanguageInOutStatementImpl o) {
        visitPsiElement(o);
    }
...
//    }
    ...
    public void visitNamespaceList(@NotNull final DLanguageNamespaceListImpl o) {
        visitPsiElement(o);
    }
    ...
    public void visitOutContractExpression(@NotNull final DLanguageOutContractExpressionImpl o) {
        visitPsiElement(o);
    }
    ...
    public void visitPostfixExpression(@NotNull final DLanguagePostfixExpressionImpl o) {
        visitPsiElement(o);
    }
    ...
    public void visitPragmaStatement(@NotNull final DLanguagePragmaStatementImpl o) {
        visitPsiElement(o);
    }

    public void visitQualifiedIdentifier(@NotNull final DLanguageQualifiedIdentifierImpl o) {
        visitElement(o);
    }
    ...
    public void visitShortenedFunctionBody(@NotNull final DLanguageShortenedFunctionBodyImpl o) {
        visitPsiElement(o);
    }
...
//    }
    ...
    public void visitVariadicArgumentsAttribute(@NotNull final DLanguageVariadicArgumentsAttributeImpl o) {
        visitPsiElement(o);
    }

    public void visitVariadicArgumentsAttributes(@NotNull final DLanguageVariadicArgumentsAttributesImpl o) {
        visitPsiElement(o);
    }
    ...
    public void visitThrowExpression(@NotNull final DLanguageThrowExpressionImpl o) {
        visitPsiElement(o);
    }
    ...
    public void visitStaticForeachStatement(
        DLanguageStaticForeachStatementImpl dLangStaticForeachStatement) {
