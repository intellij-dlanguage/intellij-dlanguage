...
public interface DlangInterfaceDeclaration extends PsiElement, DNamedElement, StubBasedPsiElement<DlangInterfaceDeclarationStub>, HasMembers<DlangInterfaceDeclarationStub> {
    @Nullable
