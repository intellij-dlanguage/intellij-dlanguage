...
public class DLanguageImportImpl extends DNamedStubbedPsiElementBase<DLanguageSingleImportStub> implements DLanguageImport {

  public DLanguageImportImpl(DLanguageSingleImportStub stub, IStubElementType type) {
    super(stub, type);
  }
