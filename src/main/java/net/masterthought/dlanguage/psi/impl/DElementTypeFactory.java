...
public class DElementTypeFactory {
    ...
    public static IElementType factory(@NotNull String name){
        ...
        if (name.equals("FUNC_DECLARATION")) return new FunctionDeclarationStubElementType(name);
        if (name.equals("CLASS_DECLARATION")) return new InterfaceOrClassStubElementType(name);
        ...
        if (name.equals("ALIAS_DECLARATION_SINGLE")) return new AliasInitializerStubElementType(name);
        ...
        if (name.equals("DECLARATOR_INITIALIZER")) return new DeclaratorStubElementType(name);
        ...
        if (name.equals("AUTO_DECLARATION_Y")) return new AutoDeclarationPartStubElementType(name);
        ...
        if (name.equals("IMPORT")) return new SingleImportStubElementType(name);
        ...
        if (name.equals("DECLARATOR")) return new DestructorStubElementType(name);
