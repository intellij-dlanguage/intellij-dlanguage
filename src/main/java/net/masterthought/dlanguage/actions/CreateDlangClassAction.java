 ...
 */
public class CreateDlangClassAction extends CreateFileFromTemplateAction implements DumbAware {
    ...
    public CreateDlangClassAction() {
        super(NEW_D_CLASS, "", DlangIcons.CLASS);
    }
