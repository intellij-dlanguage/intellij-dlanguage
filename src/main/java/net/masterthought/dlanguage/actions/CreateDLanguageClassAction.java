 ...
 * mostly copy-pasted from "CreateDLanguageFileAction.java"
 */
public class CreateDLanguageClassAction extends CreateFileFromTemplateAction implements DumbAware {

    private static final String NEW_D_CLASS = "New D Class";

    private static final String EMPTY_CLASS_TEMPLATE = "D Language Class";


    public CreateDLanguageClassAction() {
        super(NEW_D_CLASS, "", DLanguageIcons.CLASS);
    }
    ...
    public class ClassNameValidator implements InputValidatorEx {
        ...
        public String getErrorText(final String inputString) {
            ...
            return String.format("\'%s\' is not a valid D class name.", inputString);
        }
