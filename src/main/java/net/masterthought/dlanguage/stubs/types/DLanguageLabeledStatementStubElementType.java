...
public class DLanguageLabeledStatementStubElementType extends DNamedStubElementType<DLanguageLabeledStatementStub, DLanguageLabeledStatement> {
    public DLanguageLabeledStatementStubElementType(String debugName) {
        super(debugName);
    }
