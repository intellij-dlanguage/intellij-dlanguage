...
import net.masterthought.dlanguage.psi.impl.DLanguageIdentifierImpl;
...
public class DLanguageIdentifierStubElementType extends DNamedStubElementType<DLanguageIdentifierStub, DLanguageIdentifier> {
    public DLanguageIdentifierStubElementType(String debugName) {
        super(debugName);
    }
