...
public class DUnitTestParameters implements Cloneable {
    private
    @Nullable
    ...
    @Override
    protected DUnitTestParameters clone() {
        try {
            final DUnitTestParameters clone = (DUnitTestParameters) super.clone();
