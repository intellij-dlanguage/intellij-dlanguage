...
//
//    public static final DElementType KW_MODULE = valueOf(DeeTokens.KW_MODULE);
//    public static final DElementType KW_IMPORT = valueOf(DeeTokens.KW_IMPORT);
//    public static final DElementType LINE_END = valueOf(DeeTokens.LINE_END);
//    public static final DElementType SEMICOLON = valueOf(DeeTokens.SEMICOLON);
//
...
//
//
//    public static final DElementType OPEN_PARENS = valueOf(DeeTokens.OPEN_PARENS);
//    public static final DElementType CLOSE_PARENS = valueOf(DeeTokens.CLOSE_PARENS);
//    public static final DElementType OPEN_BRACE = valueOf(DeeTokens.OPEN_BRACE);
//    public static final DElementType CLOSE_BRACE = valueOf(DeeTokens.CLOSE_BRACE);
//    public static final DElementType OPEN_BRACKET = valueOf(DeeTokens.OPEN_BRACKET);
//    public static final DElementType CLOSE_BRACKET = valueOf(DeeTokens.CLOSE_BRACKET);
//
//
