...
public abstract class DResolveTestCase extends DLightPlatformCodeInsightFixtureTestCase {
    ...
    protected void doTest(boolean succeed) {
        ...
        if (succeed) {
            if (resolvedElement instanceof DLanguageFuncDeclaration || resolvedElement instanceof DLanguageClassDeclaration || resolvedElement instanceof DLanguageTemplateDeclaration || resolvedElement instanceof DLanguageVarDeclarator || resolvedElement instanceof DLanguageAliasDeclaration || resolvedElement instanceof DLanguageDeclaratorInitializer) {
