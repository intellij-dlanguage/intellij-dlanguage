...
class DLanguageLexerTest : DLanguageLexerTestBase("lexer") {
    ...
    fun testtokens_less_greater()         = doTest()
    fun testtokens_less_greater_equal()   = doTest()
    ...
    fun testtokens_unordered()            = doTest()
    fun testtokens_unordered_e()          = doTest()
